  ...
  return (
    <section className="mt-24 flex flex-col gap-12 border-t py-12">
      ...
      <div className="grid gap-5 md:grid-cols-3 2xl:gap-8">
        ...
        <FeatureCard
          icon={<PieChartIcon size={28} className="relative text-white" />}
          title="Analyze & Act"
